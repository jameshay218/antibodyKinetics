...
res_wd <- "~/Drive/Influenza/Ferret/PLOS Comp Bio/single_exposure_analysis"
## Full file path to folder containing the MCMC chains
#chain_wd_base <- "~/net/home/ferret/outputs/"
chain_wd_base <- "/media/james/Storage 2/ferret_results/single_exposure"
...
runs$dat_file <- ("~/net/home/ferret/inputs_Jan2019/single_exposure/single_real_data.csv")

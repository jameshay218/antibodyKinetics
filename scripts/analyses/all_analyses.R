...
#############################
## Run and save model comparison results?
do_model_comparison <- TRUE

## Can specify certain run IDs (1-128) to be included in the analysis
...
## as burn in/adaptive period? Seperate input for multivariate
## and univariate chains
...
for(i in 1:nrow(runs)){
    ## Extract run name and options from the runs table
    ...
    ## Will be set to TRUE if passes convergence diagnostics

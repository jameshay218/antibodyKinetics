...
run_1 <- run_MCMC(startTab,dat, mcmcPars1, "log_scale",create_model_group_func_cpp,NULL,NULL, version="posterior",form=form,individuals=individuals)
...
run_2 <- run_MCMC(parTab1,dat, mcmcPars1, "test2",create_model_group_func_cpp,mvrPars,NULL, form = "form",version="posterior",individuals=individuals)

...
1. Default MCMC routine scripts (for quick runs) ([https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/native_MCMC](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/native_MCMC)):
    a) [Cluster setup](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/native_MCMC/cluster_setup.R): creates a connection to the DIDE cluster and installs the required packages from local source files
    b) [MCMC fitting routine function](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/native_MCMC/full_run.R): declares a function to submit a full MCMC job with specific inputs, ultimately saving 2 MCMC chains, a plot of the MCMC traces and a plot of model fits
    c) [Job submission script](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/native_MCMC/run_submission.R): takes the list of model runs and their corresponding parameter tables from `inputs/run_tracker.csv` and submits a batch of jobs to the DIDE cluster using the MCMC fitting routine function above
  
2. MCMC routine with parallel tempering (for better convergence) ([https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/parallel_tempering](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/parallel_tempering))
    a) [Cluster setup](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/parallel_tempering/cluster_setup.R): creates a connection to the DIDE cluster and installs the required packages from local source files
    b) [MCMC fitting routine function](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/parallel_tempering/full_run.R): declares a function to submit a full MCMC job using parallel tempering with specific inputs, ultimately saving 2 MCMC chains, a plot of the MCMC traces and a plot of model fits
    c) [Job submission script](https://github.com/jameshay218/antibodyKinetics/tree/master/scripts/cluster/parallel_tempering/run_submission.R): takes the list of model runs and their corresponding parameter tables from `inputs/run_tracker.csv` and submits a batch of jobs to the DIDE cluster using the MCMC fitting routine function above

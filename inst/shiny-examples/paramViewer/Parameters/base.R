...
p_isolated <- create_model_group_func_cpp(parTab,exposureTab,dat=data_isolated,version="posterior",form="isolated",individuals = rep(3,5),
                                          cross_reactivity=FALSE,typing=FALSE)
...
mcmcPars1 <- c("iterations"=100000,"popt"=0.44,"opt_freq"=1000,"thin"=10,
...
mcmcPars1 <- c("iterations"=100000,"popt"=0.234,"opt_freq"=1000,"thin"=10,"adaptive_period"=20000,
               "save_block"=500)
